...
const HelpPage = () => {
  ...
  if (Object.values(formData).every(field => field.trim() !== '')) {
    try {
      const response = await fetch("http://localhost/ProgPracticeBackend/guardar_mensaje_ayuda.php", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          ...formData,
          userId: userId ? parseInt(userId) : null // Solo si existe en localStorage
        }),
      });
