            ...
            <div className={styles.buttonCenter}>
              <button
                ...
                onClick={async () => {
                  ...
                  // Usa el courseId de Java según tu base de datos, por ejemplo 2
                  const courseId = 2; // O usa: const courseId = location.state?.courseId || 2;
                  if (!userId || !courseId) {
                  ...
                  try {
                    ...
                    if (result.success) {
                      navigate("/app/courses/theory/java", { state: { courseId } });
                    } else {
