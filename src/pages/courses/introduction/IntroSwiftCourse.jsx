            ...
            <div className={styles.buttonCenter}>
              <button
                ...
                onClick={async () => {
                  ...
                  // Usa el courseId de Swift según tu base de datos, por ejemplo 4
                  const courseId = 4; // O usa: const courseId = location.state?.courseId || 4;
                  if (!userId || !courseId) {
                  ...
                  try {
                    ...
                    if (result.success) {
                      navigate("/app/courses/theory/swift", { state: { courseId } });
                    } else {
